...
public class StockMarket : MonoBehaviour
{
    ...
    private void InitializeStocks()
    {
        ...
        stocks = new List<Stock>
        {
         new Stock(
            ...
            UnityEngine.Random.Range(10.0f, 100.0f)
        ),
        new Stock(
            "Amazon",
            "AMZN",
    ...
    public void CalculateWallet()
    {
        ...
        // get the list of playercontrollers form boardcontroller
        List<PlayerInventory> playerInventories = boardController.GetPlayers();
        //calculate the new value of the wallet
